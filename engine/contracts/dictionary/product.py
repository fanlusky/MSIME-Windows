...
Consumers vendor this file from the engine's contract directory. CI must compare
the vendored bytes with this copy. Lock-file digests remain the trust anchor; this
